...
CPP = /opt/caanoo/gcc-4.2.4-glibc-2.7-eabi/bin/arm-gph-linux-gnueabi-gcc -DMOBILE_DEVICE -DARMCPU -DCAANOO -DDOUBLEBUFFERING_BLIT $(GENERAL_TWEAKS) $(SMALL_RESOLUTION_DEVICES)
